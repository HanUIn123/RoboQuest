...
{
public:
    struct BULLET_SNIPER_DESC : public CGameObject::GAMEOBJECT_DESC
    {

    };

private:
    CBullet_Sniper(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
    CBullet_Sniper(const CBullet& _Prototype);
...
public:
    static CBullet_Sniper*              Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
