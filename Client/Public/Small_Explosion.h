...
BEGIN(Client)
class CSmall_Explosion final : public CEffectPartObject
{
public:
    struct SMALL_EFFECT_DESC : public CEffectPartObject::EFFECT_PARTOBJECT_DESC
    {
...
private:
	CSmall_Explosion(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	CSmall_Explosion(const CSmall_Explosion& _Prototype);
	virtual ~CSmall_Explosion() = default;
...
public:
	static CSmall_Explosion* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
