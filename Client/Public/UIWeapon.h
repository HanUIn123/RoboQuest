...
BEGIN(Client)
class CUIWeapon final : public CUIObject
{
public:
    struct UIWEAPON_DESC : public CUIObject::UIOBJECT_DESC
    {
        _uint iTextureIndex;
    };
...
private:
    CUIWeapon(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
    CUIWeapon(const CUIWeapon& _Prototype);
...
public:
    static CUIWeapon*               Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
