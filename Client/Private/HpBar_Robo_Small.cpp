...
CHpBar_Robo_Small::CHpBar_Robo_Small(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext)
    :CMon_HpBar{_pDevice, _pContext}
{
}

CHpBar_Robo_Small::CHpBar_Robo_Small(const CHpBar_Robo_Small& _Prototype)
    :CMon_HpBar(_Prototype)
{
}

HRESULT CHpBar_Robo_Small::Initialize_Prototype()
{
...
HRESULT CHpBar_Robo_Small::Initialize(void* _pArg)
{
...
void CHpBar_Robo_Small::Priority_Update(_float _fTimeDelta)
{
}

void CHpBar_Robo_Small::Late_Update(_float _fTimeDelta)
{
    __super::Late_Update(_fTimeDelta);
}

HRESULT CHpBar_Robo_Small::Render()
{
    if (!m_bShowHealthBar)
        return S_OK;
...
HRESULT CHpBar_Robo_Small::Ready_Components()
{
...
CHpBar_Robo_Small* CHpBar_Robo_Small::Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext)
{
    CHpBar_Robo_Small* pInstance = new CHpBar_Robo_Small(_pDevice, _pContext);
    if (FAILED(pInstance->Initialize_Prototype()))
    {
        MSG_BOX("Failed To Created : CHpBar_Robo_Small");
        Safe_Release(pInstance);
    }
    return pInstance;
}

CGameObject* CHpBar_Robo_Small::Clone(void* _pArg)
{
    CHpBar_Robo_Small* pInstance = new CHpBar_Robo_Small(*this);
    if (FAILED(pInstance->Initialize(_pArg)))
    {
        MSG_BOX("Failed To Cloned : CHpBar_Robo_Small");
        Safe_Release(pInstance);
    }
